...
#satan
cl = LINETCR.LINE()
cl.login(token='EnjFi13RFMguPqueLZ04.vbU6UHxwJZPLiqAG3LO/La.JxRgLVMFqBa3iKe9gNMWpAdzeuhGv6CDbMLmkqaPfUc=')
cl.loginResult()
#dog
ki1 = LINETCR.LINE()
ki1.login(token='EnwzBYaKpjwzoXQhdqXd.f41DoffOio7QHS5kSVyVlq.oaV9Vy4Ik5SaaB6az3KtK/aMJhlHBxtR0Zpw/7cEt4s=')
ki1.loginResult()
#cat
ki2 = LINETCR.LINE()
ki2.login(token='En1Uj8TXSxrBGnSvSnv1.3F5mAYbgAHDqpBJBma2x0q.ONSykOEraOwK4ZnV6OvcI+UeQSJMq+ObEwXFJBL2TeM=')
ki2.loginResult()

ki3 = LINETCR.LINE()
ki3.login(token='EnvU5Qtezl1m5Zm6diG1.OFdc2oVa5NtbpXhRKHafmq.uzs5+rjC/9m5KXlC0KJW8Owr61EexniIHJx5C3h/DA4=')
ki3.loginResult()

ki4 = LINETCR.LINE()
ki4.login(token='EnSXd9yEEIQcjXEQPc63.g3V1VYdjPTVRkLmEcvSbCW.46teEnYigi1aVcsU5oiTlVtTQl64omj/Jj8QfGwKMVI=')
ki4.loginResult()
                ...
                if mid in op.param3:
                    ...
                    try:
                        ...
                        try:
                            ...
                            print ("[CMD] client Kick regulation or Because it does not exist in the group、\n["+op.param1+"]\nの\n["+op.param2+"]\nを蹴る事ができませんでした。\nブラックリストに追加します。")
